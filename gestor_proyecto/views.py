...
def nuevo_registro(request):
    ...
    proyectos = [
        Proyecto(
            ...
            descripcion="Aplicación para administrar préstamos y devoluciones de libros.",
            duracion=120
        ),

        Proyecto(
            nombre="Tienda Virtual",
            descripcion="Plataforma para la venta de productos en línea con carrito de compras.",
            duracion=180
        ),

        Proyecto(
            nombre="Control de Inventario",
            descripcion="Sistema para registrar productos, entradas y salidas de un almacén.",
            duracion=90
        ),

        Proyecto(
            nombre="Agenda Médica",
            descripcion="Aplicación para gestionar citas y pacientes en un consultorio.",
            duracion=150
        ),

        Proyecto(
            nombre="Portal Académico",
            descripcion="Sistema para consultar notas, horarios y asignaturas.",
            duracion=200
        ),

        Proyecto(
            nombre="Gestión de Empleados",
            descripcion="Aplicación para registrar empleados y controlar asistencia.",
            duracion=160
        ),

        Proyecto(
            nombre="Restaurante Express",
            descripcion="Sistema para tomar pedidos y administrar el menú de un restaurante.",
            duracion=110
        ),

        Proyecto(
            nombre="Reserva de Hoteles",
            descripcion="Plataforma para realizar reservas de habitaciones en línea.",
            duracion=210
        ),

        Proyecto(
            nombre="Control de Vehículos",
            descripcion="Sistema para administrar vehículos, mantenimientos y conductores.",
            duracion=140
        ),

        Proyecto(
            nombre="Gestión de Eventos",
            descripcion="Aplicación para organizar eventos, asistentes y cronogramas.",
            duracion=170
        )
    ]
